	...
	* ============== */
	...
	// extends by ahern88
	  ...
	  $.alert = function( message ) {
	        var $box = createBox();
	        $box.find("span#_title").html("<h4 class='icon-minus-sign'> 消息提示</h4>");
	        $box.find("div#_content").html("<p>" + message + "</p>");
	        $box.find("button#_cancel").remove();
	        $box.find("button#_ok").unbind().click(function(){
	  ...
	  $.box = function (options) {
	        var $box = createBox();
	        var defaults = {
	          title: "<h4 class='icon-exclamation-sign'> 信息显示</h4>",
	          html: "",
	          ok: "保存",
	          okfn: function(){},
	          cancel: "取消",
	        ...
	        $box.find("span#_title").html(options.title);
	        ...
	        $box.find("button#_ok").html(options.ok).unbind().click(function(){
	          if(options.okfn())
	              $box.modal("hide");
	        });
	        $box.find("button#_cancel").html(options.cancel).unbind().click(function(){
	          if(options.cancelfn()){
	              $box.modal("hide");
	          }
	        });
